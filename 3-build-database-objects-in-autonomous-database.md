...
5. Change the URL by replacing **admin** with the value passed to the p_url_mapping_pattern parameter in the script above: **demo**. Then press enter to go to the new URL.
