...
-  Copy the following into the left pane Quick SQL window area. You can also access the data from [here](lab-resources/quicksql.txt). Review the code and click **Generate DDL**.
<pre>
